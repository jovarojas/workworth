...
public record EarningProjectionResponse(LocalDate localDate, String status, long economicSeconds, BigDecimal amount, String currencyCode, String unavailableReason) {
