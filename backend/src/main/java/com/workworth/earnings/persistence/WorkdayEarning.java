...
public class WorkdayEarning {
    ...
    private Long id;
    @Column(name = "workday_id", nullable = false, unique = true)
    ...
    @Column(name = "economic_seconds", nullable = false)
    private long economicSeconds;
    @Column(name = "raw_amount", precision = 24, scale = 12)
    private BigDecimal rawAmount;
    @Column(name = "salary_profile_id")
    private Long salaryProfileId;
    @Enumerated(EnumType.STRING)
    @Column(name = "income_source")
    private IncomeSource incomeSource;
    @Column(name = "monthly_net", precision = 19, scale = 2)
    private BigDecimal monthlyNet;
    @Column(name = "annual_net", precision = 19, scale = 2)
    private BigDecimal annualNet;
    @Column(name = "pay_periods")
    private Integer payPeriods;
    @Column(name = "currency_code", length = 3)
    private String currencyCode;
    @Column(name = "standard_hours", precision = 24, scale = 12)
    private BigDecimal standardHours;
    @Column(name = "hourly_rate", precision = 24, scale = 12)
