...
public class WorkdayTimeCorrection {
    ...
    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "meal_break_id") private MealBreak mealBreak;
    @Column(name = "previous_break_started_at") private Instant previousBreakStartedAt;
    @Column(name = "previous_break_ended_at") private Instant previousBreakEndedAt;
    @Column(name = "new_break_started_at") private Instant newBreakStartedAt;
    @Column(name = "new_break_ended_at") private Instant newBreakEndedAt;
    @Column(name = "previous_break_ended_automatically") private Boolean previousBreakEndedAutomatically;
